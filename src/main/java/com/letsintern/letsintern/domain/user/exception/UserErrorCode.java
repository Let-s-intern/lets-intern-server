...
public enum UserErrorCode implements BaseErrorCode {
    ...
    OAUTH2_DUPLICATE_USER(BAD_REQUEST, "USER_400_4", "Email_already_signed_up."),
    ADMIN_USER_FILTER_ONLY_TH(BAD_REQUEST, "USER_400_5", "기수만으로는 검색이 불가합니다. 프로그램 유형을 함께 선택해주세요"),
